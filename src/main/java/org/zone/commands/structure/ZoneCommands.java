...
import org.zone.commands.structure.region.flags.display.greetings.*;
import org.zone.commands.structure.region.flags.display.leaving.*;
...
public interface ZoneCommands {
    ...
    ZoneFlagLeavingMessageDisplaySetTitleSubtitleCommand ZONE_FLAG_LEAVING_MESSAGE_DISPLAY_SET_TITLE_SUBTITLE_COMMAND = new ZoneFlagLeavingMessageDisplaySetTitleSubtitleCommand();
    ZoneFlagLeavingMessageDisplaySetTitleFadeInCommand ZONE_FLAG_LEAVING_MESSAGE_DISPLAY_SET_TITLE_COMMAND = new ZoneFlagLeavingMessageDisplaySetTitleFadeInCommand();
    ZoneFlagLeavingMessageDisplaySetTitleStayCommand ZONE_FLAG_LEAVING_MESSAGE_DISPLAY_SET_TITLE_STAY_COMMAND = new ZoneFlagLeavingMessageDisplaySetTitleStayCommand();
    ZoneFlagLeavingMessageDisplaySetTitleFadeOutCommand ZONE_FLAG_LEAVING_MESSAGE_DISPLAY_SET_TITLE_FADE_OUT_COMMAND = new ZoneFlagLeavingMessageDisplaySetTitleFadeOutCommand();
    ...
    ZoneFlagGreetingsDisplaySetTitleSubtitleCommand ZONE_FLAG_GREETINGS_DISPLAY_SET_TITLE_SUBTITLE_COMMAND = new ZoneFlagGreetingsDisplaySetTitleSubtitleCommand();
    ...
    ZoneFlagGreetingsDisplaySetTitleStayCommand ZONE_FLAG_GREETINGS_DISPLAY_SET_TITLE_STAY_COMMAND = new ZoneFlagGreetingsDisplaySetTitleStayCommand();
    ZoneFlagGreetingsDisplaySetTitleFadeOutCommand ZONE_FLAG_GREETINGS_DISPLAY_SET_TITLE_FADE_OUT_COMMAND = new ZoneFlagGreetingsDisplaySetTitleFadeOutCommand();
