...
import org.zone.commands.structure.region.flags.damage.to.block.farmland.ZoneFlagFarmLandTrampleEnableCommand;
import org.zone.commands.structure.region.flags.damage.to.block.farmland.ZoneFlagFarmLandTrampleViewCommand;
import org.zone.commands.structure.region.flags.damage.to.player.attack.ZoneFlagDamageAttackSetEnabledCommand;
import org.zone.commands.structure.region.flags.damage.to.player.attack.ZoneFlagDamageAttackSetGroupCommand;
import org.zone.commands.structure.region.flags.damage.to.player.attack.ZoneFlagDamageAttackView;
import org.zone.commands.structure.region.flags.damage.to.player.fall.ZoneFlagPlayerFallDamageEnableDisable;
import org.zone.commands.structure.region.flags.damage.to.player.fall.ZoneFlagPlayerFallDamageSetGroup;
import org.zone.commands.structure.region.flags.damage.to.player.fall.ZoneFlagPlayerFallDamageView;
import org.zone.commands.structure.region.flags.damage.to.both.tnt.ZoneFlagTntDefuseSetEnableDisableCommand;
import org.zone.commands.structure.region.flags.damage.to.both.tnt.ZoneFlagTntDefuseView;
