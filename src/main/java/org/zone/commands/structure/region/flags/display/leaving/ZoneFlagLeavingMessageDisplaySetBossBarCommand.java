...
public class ZoneFlagLeavingMessageDisplaySetBossBarCommand implements ArgumentCommand {
    ...
    public @NotNull CommandResult run(
        ...
        opLeavingFlag.get().setDisplayType(MessageDisplayTypes.BOSS_BAR.createCopyOfDefault());
        zone.setFlag(opLeavingFlag.get());
        try {
            zone.save();
            commandContext.sendMessage(Messages.getLeavingDisplaySuccessfullyChangedToBossBar());
