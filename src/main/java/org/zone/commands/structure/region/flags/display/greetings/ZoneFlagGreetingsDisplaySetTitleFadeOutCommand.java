...
public class ZoneFlagGreetingsDisplaySetTitleFadeOutCommand implements ArgumentCommand {

    public static final ZoneArgument ZONE_ID = new ZoneArgument("zoneId",
            new ZoneArgument.ZoneArgumentPropertiesBuilder().setBypassSuggestionPermission(
                    ZonePermissions.OVERRIDE_FLAG_GREETINGS_MESSAGE_DISPLAY_SET_TITLE_FADE_OUT));
    ...
    public @NotNull Component getDescription() {
        return Messages.getGreetingsDisplaySetTitleFadeOutCommandDescription();
    }

    @Override
    public @NotNull Optional<ZonePermission> getPermissionNode() {
        return Optional.of(ZonePermissions.FLAG_GREETINGS_MESSAGE_DISPLAY_SET_TITLE_FADE_OUT);
    }
    ...
    public @NotNull CommandResult run(
        ...
        MessageDisplay titleMessageDisplay =
                new TitleMessageDisplayBuilder().setStay(Duration.of(fadeOut, timeUnit)).build();
