...
public class ZoneFlagLeavingMessageDisplaySetTitleFadeOutCommand implements ArgumentCommand {

    public static final ZoneArgument ZONE_ID = new ZoneArgument("zoneId",
            new ZoneArgument.ZoneArgumentPropertiesBuilder().setBypassSuggestionPermission(
                    ZonePermissions.OVERRIDE_FLAG_LEAVING_MESSAGE_SET_TITLE_FADE_OUT));
    ...
    public @NotNull Component getDescription() {
        return Messages.getLeavingDisplaySetTitleFadeOutCommandDescription();
    }

    @Override
    public @NotNull Optional<ZonePermission> getPermissionNode() {
        return Optional.of(ZonePermissions.FLAG_LEAVING_MESSAGE_SET_TITLE_FADE_OUT);
    }
    ...
    public @NotNull CommandResult run(
        ...
        MessageDisplay titleMessageDisplay =
                new TitleMessageDisplayBuilder().setStay(Duration.of(fadeOut, unit)).build();
