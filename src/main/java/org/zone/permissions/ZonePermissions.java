...
public enum ZonePermissions implements ZonePermission {
    ...
    FLAG_LEAVING_MESSAGE_SET_TITLE_FADE_IN(true, "zone", "region", "flag", "leaving", "display", "set", "title", "fadeIn"),
    FLAG_LEAVING_MESSAGE_SET_TITLE_STAY(true, "zone", "region", "flag", "leaving", "display", "set", "title", "stay"),
    FLAG_LEAVING_MESSAGE_SET_TITLE_FADE_OUT(true, "zone", "region", "flag", "leaving", "display", "set", "title", "fadeOut"),
